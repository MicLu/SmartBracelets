...
#line 741
typedef int (*__compar_fn_t)(const void *arg_0xb7bef458, const void *arg_0xb7bef5f0);
#line 779
__extension__ 
#line 796
__extension__ 
...
#line 260
extern double erfc(double arg_0xb7ba08c8) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 336
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0xb7a4a840), 
int (*key_eq_fn)(void *arg_0xb7a4ac88, void *arg_0xb7a4ae00));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0xb79199b8, int arg_0xb7919b10);
static double RandomUniform(void );
...
typedef TMilli SmartBraceletsC$OperationTimer$precision_tag;
...
static void SmartBraceletsC$OperationTimer$fired(void );
...
uint8_t len);
# 113 "/opt/tinyos-main-2.1.2/tos/interfaces/SplitControl.nc"
static void SmartBraceletsC$SerialSplitControl$startDone(error_t error);
#line 138
static void SmartBraceletsC$SerialSplitControl$stopDone(error_t error);
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void SmartBraceletsC$PairingTimer$fired(void );
#line 83
...
# 49 "/opt/tinyos-main-2.1.2/tos/lib/tossim/SerialActiveMessageC.nc"
am_id_t arg_0xb731a680, 
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
# 64 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void SmartBraceletsC$OperationTimer$startPeriodic(uint32_t dt);
# 55 "/opt/tinyos-main-2.1.2/tos/interfaces/Read.nc"
static error_t SmartBraceletsC$Read$read(void );
# 52 "/opt/tinyos-main-2.1.2/tos/interfaces/Random.nc"
static uint16_t SmartBraceletsC$Random$rand16(void );
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
static error_t SmartBraceletsC$AMSerialSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Packet.nc"
static uint8_t SmartBraceletsC$SerialPacket$payloadLength(
#line 74
message_t * msg);
#line 126
static 
...
SmartBraceletsC$SerialPacket$getPayload(
#line 121
message_t * msg, 
...
uint8_t len);
#line 106
static uint8_t SmartBraceletsC$SerialPacket$maxPayloadLength(void );
# 104 "/opt/tinyos-main-2.1.2/tos/interfaces/SplitControl.nc"
static error_t SmartBraceletsC$SerialSplitControl$start(void );
# 59 "/opt/tinyos-main-2.1.2/tos/interfaces/PacketAcknowledgements.nc"
...
message_t * msg);
# 64 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void SmartBraceletsC$PairingTimer$startPeriodic(uint32_t dt);
#line 78
static void SmartBraceletsC$PairingTimer$stop(void );
#line 73
...
# 50 "SmartBraceletsC.nc"
char SmartBraceletsC$deviceKey[1000][20];


uint8_t SmartBraceletsC$linkedDevice[1000];


uint8_t SmartBraceletsC$currentMode[1000];


uint16_t SmartBraceletsC$last_pos_x[1000];
uint16_t SmartBraceletsC$last_pos_y[1000];

message_t SmartBraceletsC$packet[1000];


bool SmartBraceletsC$locked[1000];

static inline void SmartBraceletsC$getDeviceKey(void );

static char *SmartBraceletsC$getMessageType(uint8_t msgType);
static char *SmartBraceletsC$getKinematicStatus(uint16_t kStatus);

static void SmartBraceletsC$sendReq(void );
static inline void SmartBraceletsC$sendResp(void );

static void SmartBraceletsC$serialSend(uint16_t x, uint16_t y, uint16_t kinematicStatus);
...
#line 300
static inline void SmartBraceletsC$SerialSplitControl$startDone(error_t err);
...
static inline void SmartBraceletsC$SerialSplitControl$stopDone(error_t err);



static inline void SmartBraceletsC$PairingTimer$fired(void );
#line 332
static inline void SmartBraceletsC$OperationTimer$fired(void );
#line 345
...
# 67 "/opt/tinyos-main-2.1.2/tos/lib/tossim/SerialActiveMessageC.nc"
...
static inline uint8_t /*SmartBraceletsAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$getKinematicStatus(void );
#line 46
...
#line 78
inline static void SmartBraceletsC$PairingTimer$stop(void ){
#line 78
  /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$stop(0U);
#line 78
}
#line 78
# 415 "SmartBraceletsC.nc"
static inline message_t *SmartBraceletsC$Receive$receive(message_t *buf, void *payload, uint8_t len)
{
  uint8_t i = 0;
  ...
  if (SmartBraceletsC$currentMode[sim_node()] == 3 && SmartBraceletsC$linkedDevice[sim_node()] != __nesc_ntoh_uint8(mess->sendingDeviceID.nxdata)) {
      sim_log_debug(206U, "radio_rec", "Received packet from unPaired Device \n");
      return buf;
    }

  sim_log_debug(207U, "radio", "---------------RECEIVING-----------------\n");
  ...
  if (len != sizeof(my_msg_t )) {
      ...
      sim_log_debug(208U, "radio_rec", "Received packet at time %s\n", sim_time_string());
      sim_log_debug(209U, "radio_pack", ">>>Pack\n \t Payload length: %hhu \n", SmartBraceletsC$Packet$payloadLength(&SmartBraceletsC$packet[sim_node()]));
      sim_log_debug_clear(210U, "radio_pack", "\t Payload Sent\n");
      sim_log_debug_clear(211U, "radio_pack", "\t\t msgType: %s \n ", SmartBraceletsC$getMessageType(__nesc_ntoh_uint8(mess->msgType.nxdata)));
      sim_log_debug_clear(212U, "radio_pack", "\t\t deviceKey: ");
      for (i = 0; i < 20; i++) sim_log_debug_clear(213U, "radio_pack", "%c", __nesc_ntoh_uint8(mess->key[i].nxdata));
      sim_log_debug_clear(214U, "radio_pack", "\n");

      sim_log_debug_clear(215U, "radio_pack", "\t\t sendingDeviceID: %hhu \n", __nesc_ntoh_uint8(mess->sendingDeviceID.nxdata));

      if (__nesc_ntoh_uint8(mess->msgType.nxdata) == 4) {
          sim_log_debug_clear(216U, "radio_pack", "\t\t Pos_X: %hu \n", __nesc_ntoh_uint16(mess->pos_X.nxdata));
          sim_log_debug_clear(217U, "radio_pack", "\t\t Pos_Y: %hu \n", __nesc_ntoh_uint16(mess->pos_Y.nxdata));
          sim_log_debug_clear(218U, "radio_pack", "\t\t Kinematic status: %s \n", SmartBraceletsC$getKinematicStatus(__nesc_ntoh_uint16(mess->kinematicStatus.nxdata)));
        }



      if (__nesc_ntoh_uint8(mess->msgType.nxdata) == 2) {
          sim_log_debug(219U, "radio_rec", "-----Entering in CLOSE_PAIRING MODE:-----\n");
          SmartBraceletsC$currentMode[sim_node()] = 2;
          SmartBraceletsC$linkedDevice[sim_node()] = (uint8_t )__nesc_ntoh_uint8(mess->sendingDeviceID.nxdata);
        }


      if (SmartBraceletsC$currentMode[sim_node()] == 1) {

          for (i = 0; i < 20; i++) {
              if (SmartBraceletsC$deviceKey[sim_node()][i] != __nesc_ntoh_uint8(mess->key[i].nxdata)) {
                  sim_log_debug(220U, "radio_rec", "Dispositivo non associabile!\n");
                  return buf;
                }
            }
          sim_log_debug(221U, "radio_rec", "Trovato dispositivo per associazione!\n");
          SmartBraceletsC$linkedDevice[sim_node()] = (uint8_t )__nesc_ntoh_uint8(mess->sendingDeviceID.nxdata);
          sim_log_debug(222U, "radio_rec", "-----Entering in CLOSE_PAIRING MODE:-----\n");
          SmartBraceletsC$currentMode[sim_node()] = 2;
          SmartBraceletsC$sendReq();
        }
      else {
        if (SmartBraceletsC$currentMode[sim_node()] == 2) {
            sim_log_debug(223U, "radio_rec", "Associato con il dispositivo %hhu, termino il pairing!\n", SmartBraceletsC$linkedDevice[sim_node()]);
            sim_log_debug(224U, "radio_rec", "Termino timer per pairing:\n");
            SmartBraceletsC$PairingTimer$stop();
            sim_log_debug(225U, "radio_rec", "-----Entering in OPERATION MODE:-----\n");
            SmartBraceletsC$currentMode[sim_node()] = 3;
          }
        }
      if (__nesc_ntoh_uint8(mess->msgType.nxdata) == 4 && __nesc_ntoh_uint8(mess->sendingDeviceID.nxdata) == SmartBraceletsC$linkedDevice[sim_node()]) {
          sim_log_debug(226U, "radio_rec", "Ricevuto messaggio dal dispositivo accoppiato:\n");
          sim_log_debug(227U, "radio_rec", "Stop Missing Timer:\n");
          SmartBraceletsC$MissingTimer$stop();
          SmartBraceletsC$MissingTimer$startOneShot(1000 * 60);

          SmartBraceletsC$last_pos_x[sim_node()] = __nesc_ntoh_uint16(mess->pos_X.nxdata);
          SmartBraceletsC$last_pos_y[sim_node()] = __nesc_ntoh_uint16(mess->pos_Y.nxdata);

          if (__nesc_ntoh_uint16(mess->kinematicStatus.nxdata) == 14) {

              sim_log_debug(228U, "radio_rec", "*****************************\n");
              sim_log_debug(229U, "radio_rec", "** FALLING status received **\n");
              sim_log_debug(230U, "radio_rec", "** from the coupled device **\n");
              sim_log_debug(231U, "radio_rec", "*****************************\n");
              sim_log_debug(232U, "radio_rec", "** FALLING POSITIONS       **\n");
              sim_log_debug(233U, "radio_rec", "** X: %10hu           **\n", __nesc_ntoh_uint16(mess->pos_X.nxdata));
              sim_log_debug(234U, "radio_rec", "** Y: %10hu           **\n", __nesc_ntoh_uint16(mess->pos_Y.nxdata));
              sim_log_debug(235U, "radio_rec", "*****************************\n");

              SmartBraceletsC$serialSend(__nesc_ntoh_uint16(mess->pos_X.nxdata), __nesc_ntoh_uint16(mess->pos_Y.nxdata), 14);
            }
        }
  ...
  sim_log_error(236U, "radio_rec", "Receiving error \n");
}
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0xb76b9298, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0xb76b9298) {
#line 78
    case 6:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0xb76b9298, msg, payload, len);
#line 78
      break;
#line 78
    }
...
#line 162
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0xb74d7730, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0xb74d7730, addr, msg, len);
#line 80
...
#line 91
{
  ...
  sim_log_debug(247U, "AMQueue", "AMQueue: request to send from %hhu (%p): passed checks\n", clientId, msg);
  ...
  if (/*AMQueueP.AMQueueImplP*/AMQueueImplP$0$current[sim_node()] >= 1) {
      ...
      sim_log_debug(248U, "AMQueue", "%s: request to send from %hhu (%p): queue empty\n", __FUNCTION__, clientId, msg);
      ...
      if (err != SUCCESS) {
          sim_log_debug(249U, "AMQueue", "%s: underlying send failed.\n", __FUNCTION__);
      ...
      sim_log_debug(250U, "AMQueue", "AMQueue: request to send from %hhu (%p): queue not empty\n", clientId, msg);
    }
  return SUCCESS;
}
...
#line 75
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0xb76c88b0, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0xb76c88b0, msg, error);
#line 110
}
#line 110
...
# 64 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void SmartBraceletsC$OperationTimer$startPeriodic(uint32_t dt){
#line 64
...
# 166 "/opt/tinyos-main-2.1.2/tos/lib/tossim/SerialActiveMessageC.nc"
static inline void *SerialActiveMessageC$Packet$getPayload(message_t *msg, uint8_t len)
#line 166
{
  if (len <= 28) {
...
inline static void * SmartBraceletsC$SerialPacket$getPayload(message_t * msg, uint8_t len){
#line 126
  void *__nesc_result;
#line 126
...
#line 126
# 162 "/opt/tinyos-main-2.1.2/tos/lib/tossim/SerialActiveMessageC.nc"
static inline uint8_t SerialActiveMessageC$Packet$maxPayloadLength(void )
#line 162
{
  return 28;
...
inline static uint8_t SmartBraceletsC$SerialPacket$maxPayloadLength(void ){
#line 106
  unsigned char __nesc_result;
#line 106
...
#line 106
# 80 "/opt/tinyos-main-2.1.2/tos/lib/tossim/SerialActiveMessageC.nc"
static inline error_t SerialActiveMessageC$AMSend$send(am_id_t id, am_addr_t addr, 
message_t *amsg, 
uint8_t len)
#line 82
{
  sim_log_debug(279U, "Serial", "Serial: sending a packet of size %d\n", len);
  return FAIL;
}

# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t SmartBraceletsC$AMSerialSend$send(am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = SerialActiveMessageC$AMSend$send(AM_SERIAL_MSG, addr, msg, len);
#line 80
...
#line 80
# 63 "/opt/tinyos-main-2.1.2/tos/lib/tossim/SerialActiveMessageC.nc"
static inline serial_header_t *SerialActiveMessageC$getHeader(message_t *amsg)
#line 63
{
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Packet.nc"
inline static uint8_t SmartBraceletsC$SerialPacket$payloadLength(message_t * msg){
#line 78
  unsigned char __nesc_result;
#line 78
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0xb76b9930, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0xb76b9930, msg, payload, len);
#line 78
...
#line 104
# 64 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void SmartBraceletsC$PairingTimer$startPeriodic(uint32_t dt){
#line 64
  /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$startPeriodic(0U, dt);
#line 64
}
#line 64
# 284 "SmartBraceletsC.nc"
static inline void SmartBraceletsC$SplitControl$startDone(error_t err)
{
  if (err == SUCCESS) 
    {
      sim_log_debug(180U, "radio", "Radio on on node %d!\n", TOS_NODE_ID);

      sim_log_debug(181U, "boot", "Sono il Nodo %u, attivo il PAIRING timer.\n", TOS_NODE_ID);
      SmartBraceletsC$PairingTimer$startPeriodic(1000);
    }
  else 
...
# 302 "SmartBraceletsC.nc"
static inline void SmartBraceletsC$SplitControl$stopDone(error_t err)
{

  sim_log_debug(182U, "boot", "Radio stopped!\n");
}
...
# 100 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0xb74dac98, message_t * msg, error_t error){
#line 100
  switch (arg_0xb74dac98) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0xb74dac98, msg, error);
#line 100
      break;
#line 100
    }
...
#line 113
  SmartBraceletsC$SerialSplitControl$startDone(error);
#line 113
}
#line 113
# 67 "/opt/tinyos-main-2.1.2/tos/lib/tossim/SerialActiveMessageC.nc"
...
#line 138
  SmartBraceletsC$SerialSplitControl$stopDone(error);
#line 138
}
#line 138
# 68 "/opt/tinyos-main-2.1.2/tos/lib/tossim/SerialActiveMessageC.nc"
static inline void SerialActiveMessageC$stopDone$runTask(void )
#line 68
{
#line 68
...
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0xb7875650){
#line 75
  switch (arg_0xb7875650) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0xb7875650);
#line 75
      break;
#line 75
    }
...
static inline void SmartBraceletsC$PairingTimer$fired(void )
{
  ...
  sim_log_debug_clear(183U, "radio_ack", "\n");
  sim_log_debug(184U, "radio_ack", "Pairing Timer fired. \n");
...
#line 332
{
  sim_log_debug_clear(185U, "radio_ack", "\n");
  sim_log_debug(186U, "radio_ack", "Operation Timer fired at time %s \n", sim_time_string());
  if (SmartBraceletsC$locked[sim_node()]) 
    {
      return;
    }
...
#line 345
{
  sim_log_debug_clear(187U, "radio_ack", "\n");
  sim_log_debug(188U, "radio_ack", "Missing Timer fired at time %s \n", sim_time_string());
  if (SmartBraceletsC$locked[sim_node()]) 
    {
      return;
    }
    ...
    {
      sim_log_debug(189U, "radio_rec", "****************************************************************\n");
      sim_log_debug(190U, "radio_rec", "** MISSING TIMER:  %s                           **\n", sim_time_string());
      sim_log_debug(191U, "radio_rec", "** no message received from the coupled device in 1 minute:   **\n");
      sim_log_debug(192U, "radio_rec", "****************************************************************\n");
      sim_log_debug(193U, "radio_rec", "** LAST RECEIVED POSITION *******\n");
      sim_log_debug(194U, "radio_rec", "** X: %10hu               **\n", SmartBraceletsC$last_pos_x[sim_node()]);
      sim_log_debug(195U, "radio_rec", "** Y: %10hu               **\n", SmartBraceletsC$last_pos_y[sim_node()]);
      sim_log_debug(196U, "radio_rec", "*********************************\n");

      SmartBraceletsC$serialSend(SmartBraceletsC$last_pos_x[sim_node()], SmartBraceletsC$last_pos_y[sim_node()], 15);
    }
}
...
#line 23
{
  ...
  uint8_t kinematicStatus = /*SmartBraceletsAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Random$rand16() % 100;
...
#line 540
  ...
  sim_log_debug(237U, "radio_pack", "Kinematic Status letto dal sensore: %s \n", SmartBraceletsC$getKinematicStatus(data));


  sim_log_debug(238U, "radio_pack", "Preparing the response-message... \n");

  __nesc_hton_uint8(rcm->msgType.nxdata, 4);


  __nesc_hton_uint16(rcm->pos_X.nxdata, SmartBraceletsC$Random$rand16());
  __nesc_hton_uint16(rcm->pos_Y.nxdata, SmartBraceletsC$Random$rand16());
  __nesc_hton_uint16(rcm->kinematicStatus.nxdata, data);

  sim_log_debug(239U, "radio_send", "Richiedo l'ACK per il messaggio! \n");
  SmartBraceletsC$PacketAcknowledgements$requestAck(&SmartBraceletsC$packet[sim_node()]);

  if (SmartBraceletsC$AMSend$send(SmartBraceletsC$linkedDevice[sim_node()], &SmartBraceletsC$packet[sim_node()], sizeof(my_msg_t )) == SUCCESS) 
    {
      sim_log_debug(240U, "radio_send", "Sending the packet at time %s \n", sim_time_string());
      sim_log_debug(241U, "radio_pack", ">>>Pack\n \t Payload length: %hhu \n", SmartBraceletsC$Packet$payloadLength(&SmartBraceletsC$packet[sim_node()]));
      sim_log_debug_clear(242U, "radio_pack", "\t Payload Sent\n");
      sim_log_debug_clear(243U, "radio_pack", "\t\t msgType: %s \n ", SmartBraceletsC$getMessageType(__nesc_ntoh_uint8(rcm->msgType.nxdata)));
      sim_log_debug_clear(244U, "radio_pack", "\t\t Pos_X: %hu \n", __nesc_ntoh_uint16(rcm->pos_X.nxdata));
      sim_log_debug_clear(245U, "radio_pack", "\t\t Pos_Y: %hu \n", __nesc_ntoh_uint16(rcm->pos_Y.nxdata));
      sim_log_debug_clear(246U, "radio_pack", "\t\t Kinematic Status: %s \n", SmartBraceletsC$getKinematicStatus(__nesc_ntoh_uint16(rcm->kinematicStatus.nxdata)));
...
#line 46
{
  /*SmartBraceletsAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$readDone(SUCCESS, /*SmartBraceletsAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$getKinematicStatus());
}
...
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0xb73583a8){
#line 83
  switch (arg_0xb73583a8) {
#line 83
    case 0U:
#line 83
      SmartBraceletsC$PairingTimer$fired();
#line 83
      break;
#line 83
    case 1U:
#line 83
      SmartBraceletsC$OperationTimer$fired();
#line 83
      break;
#line 83
    case 2U:
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0xb73583a8);
#line 83
      break;
#line 83
    }
...
#line 67
# 70 "/opt/tinyos-main-2.1.2/tos/lib/tossim/SerialActiveMessageC.nc"
static inline error_t SerialActiveMessageC$SplitControl$start(void )
#line 70
{
...
# 104 "/opt/tinyos-main-2.1.2/tos/interfaces/SplitControl.nc"
inline static error_t SmartBraceletsC$SerialSplitControl$start(void ){
#line 104
  unsigned char __nesc_result;
#line 104
...
#line 80
  ...
  if (fp == (void *)0) {
      sim_log_debug(148U, "boot", "File di configurazione non trovato, lo creo\n");
      sim_log_debug(149U, "boot", "Sono un parent device, creo una nuova chiave\n");
      fp = fopen("DeviceKey.txt", "w");
      for (i = 0; i < 20; i++) {
          char toSave = 'A' + SmartBraceletsC$Random$rand16() % 26;

#line 87
          fputc(toSave, fp);
          SmartBraceletsC$deviceKey[sim_node()][i] = toSave;
        }
    }
  else {
      if (TOS_NODE_ID % 2 == 0) {

          sim_log_debug(150U, "boot", "File di configurazione trovato, lo leggo\n");
          sim_log_debug(151U, "boot", "Sono un child device, leggo la chiave dal file\n");
          fp = fopen("DeviceKey.txt", "r");
          fseek(fp, -20, 2);
          for (i = 0; i < 20; i++) {
              SmartBraceletsC$deviceKey[sim_node()][i] = fgetc(fp);
            }
        }
      else 
        {

          sim_log_debug(152U, "boot", "File di configurazione trovato\n");
          sim_log_debug(153U, "boot", "Sono un parent device, creo una nuova chiave\n");
...
static inline void SmartBraceletsC$Boot$booted(void )
{
  sim_log_debug_clear(175U, "boot", "\n\n");
  sim_log_debug(176U, "boot", "Application booted on node %u.\n", TOS_NODE_ID);
  sim_log_debug(177U, "boot", "Boot at time %s \n", sim_time_string());

  SmartBraceletsC$getDeviceKey();
  sim_log_debug(178U, "boot", "Device key: %s\n", SmartBraceletsC$deviceKey[sim_node()]);

  sim_log_debug(179U, "boot", "-----Entering in PAIRING MODE:-----\n");
  SmartBraceletsC$currentMode[sim_node()] = 1;

  SmartBraceletsC$SplitControl$start();
  SmartBraceletsC$SerialSplitControl$start();
}
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Packet.nc"
static uint8_t SmartBraceletsC$Packet$payloadLength(message_t * msg){
#line 78
  unsigned char __nesc_result;
#line 78
...
#line 173
  ...
  sim_log_debug(154U, "radio", "---------------SENDING-----------------\n");

  sim_log_debug(155U, "radio_pack", "Preparing the message... \n");
  sim_log_debug(156U, "radio_pack", "Current mode: %s\n", SmartBraceletsC$getMessageType(SmartBraceletsC$currentMode[sim_node()]));
  switch (SmartBraceletsC$currentMode[sim_node()]) {

      case 1: 
        __nesc_hton_uint8(rcm->msgType.nxdata, 1);
      dest = AM_BROADCAST_ADDR;
      sim_log_debug(157U, "radio_pack", "Destination: BROADCAST\n");
      break;

      case 2: 
        __nesc_hton_uint8(rcm->msgType.nxdata, 2);
      dest = SmartBraceletsC$linkedDevice[sim_node()];
      sim_log_debug(158U, "radio_pack", "Destinatario: %hhu\n", dest);
      sim_log_debug(159U, "radio_pack", "Richiedo l'ACK per il messaggio! \n");
      SmartBraceletsC$PacketAcknowledgements$requestAck(&SmartBraceletsC$packet[sim_node()]);
      break;

      case 3: 
        sim_log_debug(160U, "radio_pack", "TEST: sono in OPERATION MODE preparo il pacchetto...\n");
      break;
    }


  for (i = 0; i < 20; i++) {
      __nesc_hton_uint8(rcm->key[i].nxdata, (unsigned char )SmartBraceletsC$deviceKey[sim_node()][i]);
    }
  __nesc_hton_uint8(rcm->sendingDeviceID.nxdata, TOS_NODE_ID);

  if (SmartBraceletsC$AMSend$send(dest, &SmartBraceletsC$packet[sim_node()], sizeof(my_msg_t )) == SUCCESS) 
    {
      sim_log_debug(161U, "radio_send", "Sending the packet at time %s \n", sim_time_string());
      sim_log_debug(162U, "radio_pack", ">>>Pack\n \t Payload length: %hhu \n", SmartBraceletsC$Packet$payloadLength(&SmartBraceletsC$packet[sim_node()]));
      sim_log_debug_clear(163U, "radio_pack", "\t Payload Sent\n");
      sim_log_debug_clear(164U, "radio_pack", "\t\t msgType: %s \n ", SmartBraceletsC$getMessageType(__nesc_ntoh_uint8(rcm->msgType.nxdata)));
      sim_log_debug_clear(165U, "radio_pack", "\t\t deviceKey: ");
      for (i = 0; i < 20; i++) sim_log_debug_clear(166U, "radio_pack", "%c", __nesc_ntoh_uint8(rcm->key[i].nxdata));
      sim_log_debug_clear(167U, "radio_pack", "\n");

      sim_log_debug_clear(168U, "radio_pack", "\t\t sendingDeviceID: %hhu \n", __nesc_ntoh_uint8(rcm->sendingDeviceID.nxdata));
  ...
  if (&SmartBraceletsC$packet[sim_node()] == buf && err == SUCCESS) 
    {
      ...
      sim_log_debug(197U, "radio_send", "Packet correctly sent...");
      sim_log_debug_clear(198U, "radio_send", " at time %s \n", sim_time_string());


      if (SmartBraceletsC$currentMode[sim_node()] == 2) {
          if (SmartBraceletsC$PacketAcknowledgements$wasAcked(&SmartBraceletsC$packet[sim_node()])) {
              sim_log_debug(199U, "radio_send", "Ack ricevuto\n");
              sim_log_debug(200U, "radio_rec", "Termino timer per pairing:\n");
              SmartBraceletsC$PairingTimer$stop();
              sim_log_debug(201U, "radio_rec", "-----Entering in OPERATION MODE:-----\n");
              SmartBraceletsC$currentMode[sim_node()] = 3;
              SmartBraceletsC$OperationTimer$startPeriodic(1000 * 10);
            }
          else 
#line 393
            {
              sim_log_debug(202U, "radio_send", "*********Ack NON ricevuto***********\n");
            }
        }
      else {
#line 397
        if (SmartBraceletsC$currentMode[sim_node()] == 3) {
            if (SmartBraceletsC$PacketAcknowledgements$wasAcked(&SmartBraceletsC$packet[sim_node()])) {
                sim_log_debug(203U, "radio_send", "Ack per INFO msg ricevuto\n");
              }
            else 
#line 400
              {
                sim_log_debug(204U, "radio_send", "*********Ack per INFO msg NON ricevuto***********\n");
              }
          }
        }
    }
    ...
    {
      sim_log_error(205U, "radio_send", "Send done error!\n");
    }
}
...
# 226 "SmartBraceletsC.nc"
static void SmartBraceletsC$serialSend(uint16_t x, uint16_t y, uint16_t kinematicStatus)
#line 226
{

  serial_msg_t *rcm = (serial_msg_t *)SmartBraceletsC$SerialPacket$getPayload(&SmartBraceletsC$packet[sim_node()], sizeof(serial_msg_t ));
...
#line 229
  ...
  if (SmartBraceletsC$SerialPacket$maxPayloadLength() < sizeof(serial_msg_t )) {
      return;
    }


  __nesc_hton_uint16(rcm->pos_X.nxdata, x);
  __nesc_hton_uint16(rcm->pos_Y.nxdata, y);
  __nesc_hton_uint16(rcm->kinematicStatus.nxdata, kinematicStatus);

  if (SmartBraceletsC$AMSerialSend$send(AM_BROADCAST_ADDR, &SmartBraceletsC$packet[sim_node()], sizeof(serial_msg_t )) == SUCCESS) {
      sim_log_debug(169U, "radio_send", "Sending the SERIAL packet at time %s \n", sim_time_string());
      sim_log_debug(170U, "radio_pack", ">>>Pack\n \t Payload length: %hhu \n", SmartBraceletsC$SerialPacket$payloadLength(&SmartBraceletsC$packet[sim_node()]));
      sim_log_debug_clear(171U, "radio_pack", "\t Payload Sent\n");
      sim_log_debug_clear(172U, "radio_pack", "\t\t X : %hu \n ", SmartBraceletsC$getMessageType(__nesc_ntoh_uint16(rcm->pos_X.nxdata)));
      sim_log_debug_clear(173U, "radio_pack", "\t\t Y : %hu \n ", SmartBraceletsC$getMessageType(__nesc_ntoh_uint16(rcm->pos_Y.nxdata)));
      sim_log_debug_clear(174U, "radio_pack", "\t\t Kinematic Status : %s \n ", SmartBraceletsC$getKinematicStatus(__nesc_ntoh_uint16(rcm->kinematicStatus.nxdata)));
    }
}
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  if (!strcmp(varname, "SmartBraceletsC$deviceKey"))
  {
    *addr = (uintptr_t)&SmartBraceletsC$deviceKey[__nesc_mote];
    *size = sizeof(SmartBraceletsC$deviceKey[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SmartBraceletsC$linkedDevice"))
  {
    *addr = (uintptr_t)&SmartBraceletsC$linkedDevice[__nesc_mote];
    *size = sizeof(SmartBraceletsC$linkedDevice[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SmartBraceletsC$currentMode"))
  {
    *addr = (uintptr_t)&SmartBraceletsC$currentMode[__nesc_mote];
    *size = sizeof(SmartBraceletsC$currentMode[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SmartBraceletsC$last_pos_x"))
  {
    *addr = (uintptr_t)&SmartBraceletsC$last_pos_x[__nesc_mote];
    *size = sizeof(SmartBraceletsC$last_pos_x[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SmartBraceletsC$last_pos_y"))
  {
    *addr = (uintptr_t)&SmartBraceletsC$last_pos_y[__nesc_mote];
    *size = sizeof(SmartBraceletsC$last_pos_y[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  /* Module SmartBraceletsC */
  memset((void *)&SmartBraceletsC$deviceKey[__nesc_mote], 0, sizeof SmartBraceletsC$deviceKey[__nesc_mote]);
  memset((void *)&SmartBraceletsC$linkedDevice[__nesc_mote], 0, sizeof SmartBraceletsC$linkedDevice[__nesc_mote]);
  memset((void *)&SmartBraceletsC$currentMode[__nesc_mote], 0, sizeof SmartBraceletsC$currentMode[__nesc_mote]);
  memset((void *)&SmartBraceletsC$last_pos_x[__nesc_mote], 0, sizeof SmartBraceletsC$last_pos_x[__nesc_mote]);
  memset((void *)&SmartBraceletsC$last_pos_y[__nesc_mote], 0, sizeof SmartBraceletsC$last_pos_y[__nesc_mote]);
  memset((void *)&SmartBraceletsC$packet[__nesc_mote], 0, sizeof SmartBraceletsC$packet[__nesc_mote]);
  memset((void *)&SmartBraceletsC$locked[__nesc_mote], 0, sizeof SmartBraceletsC$locked[__nesc_mote]);
